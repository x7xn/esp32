...
#define LIGHTBULB_NOTIFY_A2_MASK			0X80

#define SWITCH_NOTIFY_SW1_MASK				0X01
#define SWITCH_NOTIFY_SW2_MASK				0X02
#define SWITCH_NOTIFY_SW3_MASK				0X04
#define SWITCH_NOTIFY_SW4_MASK				0X08

#define CURTAIN_NOTIFY_TARGET_POS_MASK		0X01
#define CURTAIN_NOTIFY_POS_STATE_MASK		0X02
#define CURTAIN_NOTIFY_CURRENT_POS_MASK		0X04


/*<MESH_SUB_DEVICE_TYPE 子设备ID中高两位字节表示的类型>*/
...
#define SUB_TYPE_SW_CONTROLLER_COMPATIBLE 		((uint16_t)0x3066)/*<通断器兼容>*/
...
typedef enum{
	...
	HAP_TYPE_DOUBLE_LIGHTBULB_E,				/*<双色灯>*/
	HAP_TYPE_RGB_LIGHTBULB_E,					/*<RGB灯>*/
	HAP_TYPE_WYRGB_LIGHTBULB_E,					/*<WYRGB灯>*/
	HAP_TYPE_DOUBLE_PLUS_LIGHTBULB_E,			/*<双色灯+辅灯>*/
	HAP_TYPE_SINGLE_PLUS_LIGHTBULB_E,			/*<单色灯+辅灯>*/
	HAP_TYPE_WRGB_LIGHTBULB_E,					/*<WRGB灯>*/
	HAP_TYPE_CLASSROOM_SINGLE_LIGHTBULB_E,		/*<教室单色灯>*/
	HAP_TYPE_ILLUMINANCE_SENSOR_E, 				/*<照度传感器>*/
	HAP_TYPE_ELECTRIC_CURTAINS_E, 				/*<电动窗帘>*/
	HAP_TYPE_SW_CONTROLLER_E, 					/*<开关控制器/通断器>*/
	HAP_TYPE_SWITCH_1KEY_E,						/*<1开开关>*/
	HAP_TYPE_SWITCH_2KEY_E,						/*<2开开关>*/
	HAP_TYPE_SWITCH_3KEY_E,						/*<3开开关>*/
	HAP_TYPE_SWITCH_4KEY_E,						/*<4开开关>*/
	HAP_TYPE_AUDIBLE_VISUAL_ALARM_E,			/*<声光报警器>*/
	HAP_TYPE_ELECTRIC_VALVE_E,					/*<电动阀门>*/
	HAP_TYPE_SMART_OUTLET_E, 					/*<智能插座>*/
	HAP_TYPE_MAGNETIC_DOOR_SENSOR_E,			/*<门磁传感器>*/
	HAP_TYPE_IR_SENSOR_E,						/*<红外传感器&门锁?>*/
	MESH_SUB_TYPE_UNDER_WATER_SENSOR_E,			/*<水浸传感器>*/
	MESH_SUB_TYPE_SMOKE_SENSOR_E,				/*<烟雾传感器>*/
	HAP_TYPE_GAS_SENSOR_E,						/*<燃气传感器>*/
	HAP_TYPE_SCENE_1KEY_E,						/*<1键情景面板>*/
	HAP_TYPE_SCENE_2KEY_E, 						/*<2键情景面板>*/
	HAP_TYPE_SCENE_3KEY_E,						/*<3键情景面板>*/
	HAP_TYPE_SCENE_4KEY_E, 						/*<4键情景面板>*/
